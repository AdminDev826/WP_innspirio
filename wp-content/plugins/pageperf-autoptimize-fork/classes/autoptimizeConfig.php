...
<tr valign="top" class="hidden js_sub ao_adv">
<th scope="row">Command for CLI JS minifier (uglifyjs..) </th>
<td><label for="autoptimize_js_cli_minifier_path"><input type="text" style="width:100%;" name="autoptimize_js_cli_minifier_path" value="<?php echo get_option('autoptimize_js_cli_minifier_path'); ?>"/><br />
</tr>
...
<tr valign="top" class="hidden js_sub ao_adv">
<th scope="row">Command for CLI CSS minifier (cleancss..) </th>
<td><label for="autoptimize_css_cli_minifier_path"><input type="text" style="width:100%;" name="autoptimize_css_cli_minifier_path" value="<?php echo get_option('autoptimize_css_cli_minifier_path'); ?>"/><br />
</tr>
...
<?php
    ...
    register_setting('autoptimize',
      'autoptimize_css_cli_minifier_path');
    register_setting('autoptimize',
      'autoptimize_js_cli_minifier_path');
