...
LOD;
        ...
        $code = apply_filters( 
          'autoptimize_css_after_no_minify',$code );
      }
...
EOT;
          ...
          $l = sprintf("loadCSS('%s', null, '%s');", 
			...
			if($this->defer == true) {
				$deferredCssBlock .= "</script>";
				$noScriptCssBlock .= "</noscript>";
				//$this->inject_in_html($noScriptCssBlock,$replaceTag);
$this->inject_in_html($deferredCssBlock,array('<!-- cssdefer -->','before'));
			}
		}
