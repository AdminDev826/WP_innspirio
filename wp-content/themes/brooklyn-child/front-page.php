<?php get_header(); ?>
<!--<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/includes/particles-js/particle.css">-->
<style>
...
@media only screen and (max-width: 480px){
	body .hero .grid-container .v_poster {
	    /*max-height: 300px;*/
	}
}
  @media only screen
and (max-width : 769px) and (orientation:portrait)  {
  .hero .grid-container {
     height: auto;
     min-height: auto;
    position: relative;
}
	body #ut-hero .grid-container .v_poster {
	 	background: url('http://www.inspirio.com/wp-content/uploads/bg2-1.png');
...
margin-top: -10px;
  ...
  @media only screen
and (min-width : 769px) and (orientation:landscape){
  body #ut-hero .grid-container .v_poster {
	 	background: url('http://www.inspirio.com/wp-content/uploads/bg2-1.png');
	    background-repeat: no-repeat;
	    background-size: cover;
...
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/includes/particles-js/particles-main.js"></script>
<!-- <script src="<?php echo get_stylesheet_directory_uri(); ?>/includes/particles-js/particle.json"></script> -->
