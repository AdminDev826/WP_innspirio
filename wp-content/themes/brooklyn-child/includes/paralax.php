...
remove_action( 'ut_java_footer_hook', 'ut_needed_js', 100 );

if ( !function_exists( 'ut_needed_js_updated' ) ) {
    
  function ut_needed_js_updated() { 
        ...
        if( ot_get_option('ut_use_cache' , 'off') == 'on' && is_front_page() ) {
            ...
            $transient_prefix = isMobileOrTablet() ? '_mobile' : '_desktop';
        ...
        $js = '(function($){
				...
				*/
				...
				if( !isMobileOrTablet() && $ut_hero_type == 'video' || !isMobileOrTablet() && $ut_hero_type == 'tabs' && ut_return_hero_config('ut_video_containment', 'hero') == 'body' ) :
              ...
              function isMobile() {
                ...
                var mobile = isMobile();
                  ...
                  var s = $(this).parent().attr(\'id\'), w,h;

                  if ( (s == \'testimonials\' || s == \'partnership\' || s == \'contact-form\') && mobile ) {
                    h = $(this).parent().height() * 1.5;
                    w = $(window).width() * 1.1;
                  }
                  else if (mobile) {
                    return;
				...
				*/
				...
				if( !isMobileOrTablet() && ot_get_option('ut_animate_sections' , 'on') == 'on' ) : 
...
add_action( 'ut_java_footer_hook', 'ut_needed_js_updated', 100 );
